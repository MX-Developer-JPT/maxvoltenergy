...
export const metadata: Metadata = {
  title: "Find a Dealer",
  description: "Locate your nearest Maxvolt Energy lithium battery dealer or service center across India. 950+ dealers in Delhi, Mumbai, Bangalore, Hyderabad, Lucknow and 150+ cities.",
