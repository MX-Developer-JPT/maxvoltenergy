...
const CERTIFICATIONS: Cert[] = [
  { name: "AIS 156 Government Safety Compliance", issuer: "Automotive Industry Standards Committee, India", description: "India's mandatory automotive battery safety standard covering thermal runaway, short circuit, overcharge, and crash safety for EV batteries.", image: "/images/certificate/-zrp.webp", products: "E-Cycle, E-Scooter/Bike, E-Rickshaw", color: "#FFD100", year: "2023 / 2024" },
  { name: "TAC Certificate – 51.2V 105AH Battery", issuer: "Testing Agency, India", description: "Type Approval Certificate for the 51.2V 105AH lithium battery pack for e-rickshaw applications.", products: "E-Rickshaw Battery (MEIPLRI-51100)", color: "#FFA800", year: "2023", image: "/images/certificate/tac-maxvolt-51-2v-105ah-brz.webp" },
  { name: "TAC Certificate – 63V 40Ah Battery Model", issuer: "Testing Agency, India", description: "Type Approval Certificate for the 63V 40Ah lithium battery pack for e-scooter applications.", products: "E-Scooter Battery (MEIPLES-62940)", color: "#FF8C00", year: "2023", image: "/images/certificate/450-tac-maxvolt-62940-106-xkd.webp" },
  { name: "TAC Certificate – 63V 34Ah Battery Model", issuer: "Testing Agency, India", description: "Type Approval Certificate covering the 63V 34Ah e-scooter battery pack specifications.", products: "E-Scooter Battery (MEIPLES-62934)", color: "#7c3aed", year: "2023", image: "/images/certificate/449-tac-maxvolt-62934-105-tki.webp" },
  { name: "TAC Certificate – 63V 29Ah Battery Model", issuer: "Testing Agency, India", description: "Type Approval Certificate for the 63V 29Ah e-scooter battery pack.", products: "E-Scooter Battery (MEIPLES-62929)", color: "#f97316", year: "2023", image: "/images/certificate/448-tac-maxvolt-62929-104-kkc.webp" },
  { name: "ISO Manufacturing Quality Standards", issuer: "International Organization for Standardization", description: "Quality management systems ensuring consistent production processes, multi-stage testing, and manufacturing excellence.", products: "All Maxvolt Products", color: "#7c3aed", year: "Ongoing" },
];
