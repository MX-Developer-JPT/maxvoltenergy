...
const GROUPS: FaqGroup[] = [
  {
    ...
    items: [
      { q: "What battery chemistry does Maxvolt use?", a: "Maxvolt builds advanced lithium batteries primarily using LiFePO4 (lithium iron phosphate) and graphene-enhanced cells in our Eco-Series. These chemistries deliver longer cycle life, superior thermal stability and faster charging compared to conventional lead-acid batteries." },
